 ...
 * Description
 */
angular.module('pop.toolkit', ['LocalStorageModule', 'angular.chosen', 'pop.search.table', 'ngDragDrop']);
...
angular.module('pop.toolkit').directive('popup', function() {
  return {
    restrict: 'A',
    require: 'ngModel',
    scope: {
...
angular.module('pop.toolkit').directive('verticalResizer', ['$document', '$window', function($document, $window) {
