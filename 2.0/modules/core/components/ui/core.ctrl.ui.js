...
/*
 */
angular.module('portalchat.core').controller('core.ui', ['$rootScope', '$scope', '$log', '$timeout', 'CoreConfig', 'UiManager', 'localStorageService', function($rootScope, $scope, $log, $timeout, CoreConfig, UiManager,localStorageService) {
