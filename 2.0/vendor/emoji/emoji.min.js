...
'use strict';
emojiApp.directive('emojiFormIdler', ['$timeout', '$http', '$interpolate', '$compile', function($timeout, $http, $interpolate, $compile) {
    return {
        scope: {
            chat: '=',
            ui: '=',
    ...
    function link(scope, element, attrs) {
        ...
        $(editorElement).on('keydown', function(e) {
            ...
            if (e.keyCode == 13) {
                ...
                if (submit) {
                    $timeout.cancel(updatePromise);
                    updateValue();
                    scope.ui.fx.sendIdlerResponse(scope.chat);
                    resetTyping();
        ...
        function onKeyDown(e) {
            if (e.keyCode == 9 && !e.shiftKey && !e.ctrlKey && !e.metaKey) {
                if (angular.isDefined($modalStack) && $modalStack.getTop && !$modalStack.getTop()) {
                    editorElement.focus();
                    return cancelEvent(e);
                }
            }
        ...
        scope.$on('$destroy', function cleanup() {
            ...
            // if( angular.isDefined(submitBtn) && $(submitBtn)){
    ...
    function link(scope, element, attrs) {
        ...
        $(editorElement).on('keydown', function(e) {
            ...
            if (e.keyCode == 13) {
                ...
                scope.ui.fx.showChatThatUserIsTyping(scope.chat.session.type, scope.chat.session.session_key);
            }
        });
...
(function($, window, document) {
    ...
    EmojiArea.createIcon = function(emoji, menu) {
        ...
        return '<img title="' + util.htmlEntities(name).replace(/:/g, '') + '" src="vendor/emoji/img/blank.gif" class="img" style="' + style + '" alt="' + util.htmlEntities(name) + '">';
    };
